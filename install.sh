...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " ${YELLOW}         REVOER SCRIPT        ${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/ataaxd/RevoerScript/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/ataaxd/RevoerScript/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/ataaxd/RevoerScript/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ataaxd/RevoerScript/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/ataaxd/RevoerScript/main/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/ataaxd/RevoerScript/main/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6282129004880"},{"text":"ɪɴꜱᴛᴀʟʟ","url":"https://t.me/sedihbatgw"}]]}'
...
wget raw.githubusercontent.com/ataaxd/RevoerScript/main/file/limit.sh && chmod +x limit.sh && ./limit.sh
